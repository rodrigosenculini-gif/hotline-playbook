...
export const PRODUCTS = [
  {
    id: 'clt',
    name: 'Crédito CLT',
    tagline: 'Empréstimo consignado para carteira assinada',
    color: '#ff5a1f',
    icon: '💼',
    playbook: {
      hero: [
      ...
      essencial: [
        { tone: 'gold', title: 'Pode ser novo ou refinanciamento', body: 'Se o cliente já tem crédito ativo, é refinanciamento (troco). Se não tem nada, é crédito novo — o discurso muda.' },
        ...
        { tone: 'blue', title: 'Depende da margem', body: 'A aprovação e o valor dependem da margem consignável disponível do trabalhador.' },
      ...
      flow: [
        ...
        { title: '5. Feche', sub: 'Leve ao WhatsApp' },
      ],
      cenarios: [
    ...
    tips: [
      ...
      { title: 'Diferencie novo x refin', body: 'Pergunte logo se o cliente já tem crédito ativo — isso muda toda a abordagem.' },
      { title: 'Negocie em etapas', body: 'Não entregue a melhor condição de cara: original → prazo → outra adequação.' },
      { title: 'Reprovado não é não', body: 'Registre o follow-up para quando surgirem novos limites — não prometa nada no calor da hora.' },
      { title: 'Ligue antes do WhatsApp', body: 'Uma ligação antes da mensagem passa mais profissionalismo e aumenta a resposta.' },
    ],
  },
...

  {
    ...
    tagline: 'e-Consignado via Carteira de Trabalho Digital',
    color: '#e8a23a',
    icon: '📱',
    playbook: {
      hero: [
      ...
      essencial: [
        { tone: 'gold', title: 'Contratação centralizada', body: 'Tudo acontece pelo app CTPS Digital — não depende de convênio prévio entre banco e empregador.' },
        { tone: 'green', title: 'Margem de até 35%', body: 'O trabalhador pode comprometer até 35% da remuneração líquida com as parcelas.' },
        { tone: 'blue', title: 'Taxa com teto', body: 'Juros limitados a até 1,99% ao mês — vale reforçar isso na comparação com outros créditos.' },
        { tone: '', title: 'Garantias reduzem a taxa', body: 'Verbas rescisórias, multa do FGTS e até 10% do saldo do FGTS podem ser usados como garantia.' },
      ],
      highlight: '"Você compara até 100 propostas em um só lugar, direto no app do governo — e tem até 24h pra escolher a melhor."',
      flow: [
        { title: '1. Simulação', sub: 'No app CTPS Digital' },
        { title: '2. Propostas', sub: 'Até 100 instituições' },
        { title: '3. Comparação', sub: 'Até 24h para decidir' },
        { title: '4. Garantias', sub: 'Verbas, FGTS, multa' },
        { title: '5. Contratação', sub: 'Direto no app' },
      ],
      cenarios: [
      ...
      checklist: [
        'Expliquei que a contratação é pela CTPS Digital',
        'Informei o teto de margem consignável (35%)',
        'Expliquei as opções de garantia e seus efeitos',
        'Comparei taxa com e sem garantia',
        'Reforcei o prazo de 24h para comparar propostas',
      ],
    },
    tips: [
      { title: 'App do governo gera confiança', body: 'Reforce que a contratação passa pela Carteira de Trabalho Digital — isso reduz o medo de golpe.' },
      { title: 'Garantia é opcional', body: 'Deixe claro que usar o FGTS ou verbas como garantia é escolha do cliente, não obrigação.' },
      { title: 'Compare com transparência', body: 'Incentive o cliente a comparar as propostas — isso gera confiança mesmo se ele não fechar na hora.' },
      { title: 'Explique o teto de 35%', body: 'Evita frustração depois: nem sempre o valor pedido cabe dentro da margem disponível.' },
      { title: 'Cross-sell quando a margem já foi usada', body: 'Ofereça Conta de Luz ou FGTS como alternativa pra quem já bateu no limite do consignado.' },
    ],
  },
];
